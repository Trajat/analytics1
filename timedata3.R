...
(tsales3b = ts(sales, start=c(2016), end=c(2018))) # default freq=1 once a year 1st 3 values 
# becomes year sales value
...
tsales3c
plot(tsales3c)
admission = c(1000,900,800,1200)
ts1 = ts(admission,start=c(2016), end=c(2018), frequency=1)
ts1
plot(ts1)
admission = c(1000,900,1100,1500)
